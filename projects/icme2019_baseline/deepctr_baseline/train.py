...
DATA_DIR = "/ftp_samba/cephfs/algo_data/yw.shi/dataset/short_video/"
train_file = DATA_DIR + "/train/final_track2_train.txt"
test_file = DATA_DIR + "/test/final_track2_test_no_anwser.txt"
